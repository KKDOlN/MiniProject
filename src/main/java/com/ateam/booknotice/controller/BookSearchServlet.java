...
public class BookSearchServlet extends HttpServlet {
	...
	System.out.println("여기");
		...
		// 1. 2개의 값을 담을 VO를 만들기
		BookSearchVO search = new BookSearchVO(searchCondition, searchKeyword);
		System.out.println("여기3");
		// 2. HashMap을 이용하기
		List<BookNotice> searchList = nService.selectSearchList(search);
		if(searchList != null && !searchList.isEmpty()) {
			...
			request.getRequestDispatcher("/WEB-INF/views/booknotice/booksearch.jsp")
