 ...
 */
@WebServlet("/notice/membersearch")
public class MemberSearchServlet extends HttpServlet {
	...
	System.out.println("여기");
		...
		// 1. 2개의 값을 담을 VO를 만들기
		MemberSearchVO search = new MemberSearchVO(searchCondition, searchKeyword);
		System.out.println("여기3"+searchKeyword);
		// 2. HashMap을 이용하기
		List<MemberNotice> searchList = nService.selectSearchList(search);
		if(searchList != null && !searchList.isEmpty()) {
			...
			request.getRequestDispatcher("/WEB-INF/views/member/membersearch.jsp")
